...
class PostCashService
{
    ...
    {
        $params = array('marchand'  => $this->marchand, 'keyMarchand' => $this->keyMarchand, 'tel' => $params->tel );
        $result = $this->client->call('GetCardUserName', $params);
        return $result;
    }
    ...
    function rechargementespece($params)
    {
        ...
        $result = $this->client->call('RechargementEspece', $params);
        return $result;
    }
    ...
    function achatcodewoyofal($params)
    {
        ...
        $result = $this->client->call('AchatCodeWoyofal', $params);
        return $result;
    }
    ...
    function achatcredittelephonique($params)
    {
        ...
        $result = $this->client->call('AchatCreditTelephonique', $params);
        return $result;
    }
    ...
    function getinfosnumber($params)
    {
        ...
        $result = $this->client->call('GetInfosNumber', $params);
        return $result;
    }
    ...
    {
        $params = array('marchand' => $this->marchand, 'keyMarchand' => $this->keyMarchand, 'telephone' => $params->telephone);
        $result = $this->client->call('GetInfosNumberAP', $params);
        return $result;
    }
